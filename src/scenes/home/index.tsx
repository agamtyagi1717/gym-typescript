...
const Home = ({ setSelectedPage }: Props) => {
    ...
    return (
        <section id="home" className="gap-16 bg-gray-20 py-10 md:pb-0">
            <motion.div className="md:flex mx-auto w-5/6 items-center md:h-full justify-center"
            ...
            >
                <div className="z-10 mt-32 md:basis-3/5">
                    ...
                    >
                        ...
                        <p className="mt-8 text-sm">
                            Experience Training Excellence Like No Other with Unmatched
                            Fitness Classes. Step into World-Class Studios and Transform Your
                            Body into the Shape You've Always Desired. Your Path to Your Dream
                            Body Begins Now!
                        </p>
                    </motion.div>
                ...
                <div className="flex basis-3/5 justify-center md:z-10 md:ml-40 md:mt-16 md:mb-8 md:justify-items-end">
